    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="card">
                  <div class="boxs mail_listing">
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <form class="composeForm"  name="add_name" method="POST" action="<?=site_url('Manager/addDevise')?>">
                        <div class="form-group">
                            <div class="table-responsive">  
                            <table class="table table-bordered" id="dynamic_field">  
                                <tr>
                                 <td><input type="text" name="devise" placeholder="Entrez Devise" class="form-control name_list" required="" /></td>  
                            </tr>  
                        </table>  
                          </div>
                        <div class="col-lg-12">
