            ...
            <div class="main-content">
                <div class="card">
                    <div class="boxs mail_listing">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="composeForm" name="add_name" method="POST"
                                    action="<?=site_url('Province/addVille'); ?>">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="dynamic_field">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="ville[][nomVille]"
                                                            placeholder="Entrer la villle"
                                                            class="form-control name_list" required="" />
                                                    </td>
                                                    <td>
                                                        <button type="button" name="ville" id="ville"
                                                            class="btn btn-success">Ajouter un champs</button>
                                                    </td>
                                                </tr>
                                                <style>
                                                .custom-select {
