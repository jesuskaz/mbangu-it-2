                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover" style="width:100%;">
                                            ...
                                            <tbody>
                                                <?php foreach ($paies as $rapport) {
                                                ?>
                                                    <tr>
                                                        <td><?php echo $rapport["nom"]; ?></td>
                                                        <td><?php echo $rapport["postnom"]; ?></td>
                                                        <td><?php echo $rapport["matricule"]; ?></td>
                                                        <td><?php echo $rapport["compte"]; ?></td>
                                                        <td><?php echo $rapport["banque"]; ?></td>
                                                        <td><?php echo $rapport["frais"]; ?></td>
                                                        <td><?php echo $rapport["section"]; ?></td>
                                                        <td><?php echo $rapport["classe"]; ?></td>
                                                        <td style="text-align:right"><?php echo $rapport["montant"]; ?> <?php echo $rapport["devise"]; ?></td>
