										...
										<div class="row ">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
												<div class="card-content">
													<h5 class="font-15">Nombre Faculté</h5>
													<h2 class="mb-3 font-18"><?php echo $faculte; ?></h2>
												</div>
											</div>
								...
								<div class="card-statistic-4">
									<div class="align-items-center justify-content-between">
										<div class="row ">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
												<div class="card-content">
													<h5 class="font-15"> Nombre Etudiants</h5>
													<h2 class="mb-3 font-18"><?php echo $etudiant ?></h2>
												</div>
											</div>
											<!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
								...
								<div class="card-statistic-4">
									<div class="align-items-center justify-content-between">
										<div class="row ">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
												<div class="card-content">
													<h5 class="font-15">Chiffre A. journalier</h5>
								...
								<div class="card-statistic-4">
									<div class="align-items-center justify-content-between">
										<div class="row ">
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
												<div class="card-content">
													<h5 class="font-15">Chiffre A. annuel</h5>
								...
								<div class="card-header">
									...
									<div class="card-header-action">
										<div class="form-group p-0 ">
											<select name="devise" class="custom-select" id="devise">
											...
											<div class="form-inline">
												<div class="form-group m-2">
													<select id='faculte' name="faculte" style="width:130px" class="custom-select">
														...
														<?php if (isset($selectFaculte)) {
															foreach ($selectFaculte as $facultes) {
														?>
												...
												<div class="form-group m-2">
													<select id='promotion' name="promotion" style="width:130px" class="custom-select">
														...
														?>
																<option value="<?php echo $promotion['idPromoUniv']; ?>"><?php echo $promotion['intitulePromoUniv']; ?></option>
														<?php
															}
														}
														?>
												...
												<div class="form-group m-2">
													<select id='option' name="option" style="width:130px" class="custom-select">
														...
														?>
																<option value="<?php echo $option['idPromotion']; ?>"><?php echo $option['intituleOption']; ?></option>
														<?php
															}
														}
														?>
