    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        <div class="form-inline mr-auto">
          <ul class="navbar-nav mr-3">
            <li><a href="#" data-toggle="sidebar" class="nav-link nav-link-lg
                  collapse-btn"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-align-justify">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
                ...
                <div class="row">  
                  <div class="form-group col-6">
                        <select name="annee" class="custom-select data" required focus>
                          <option value="">Selectionnez une annee academique active</option>
                          <?php
                          foreach ($anneeAcademiques as $annee) {
                          ?>
                            <option value="<?php echo $annee['idanneeAcademique'] ?>"><?php echo $annee['annee'] ?></option>
                          <?php } ?>
                        </select>
                  </div>
                  <div class="form-group col-6">
                    ...
                    <div class="form-line">
                      <select type="text" id="email_address" name="banque" class="custom-select data" placeholder="Banque" required focus>
                        <!-- <option>Choisissez Banque ...</option> -->
                  ...
                  <div class="form-group col-6">
                    <div class="form-line">
                      <select type="text" id="email_address" name="devise" class="custom-select data" placeholder="Banque" required focus>
                        <!-- <option selected>Choisissez votre devise ...</option> -->
