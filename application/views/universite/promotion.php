...
<body>
                      ...
                      <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-bordered" id="dynamic_field">  
                                <tr>
                                 <td><input type="text" name="addmore[][intitulePromotion]" placeholder="Entrer la promotion" class="form-control name_list" required="" /></td>  
                                <td><button type="button" name="add" id="add" class="btn btn-success">Ajouter Promotion</button></td>  
                            </tr>  
                        </table>  
                          </div>
                        <div class="col-lg-12">
  ...
  <script type="text/javascript">
    $(document).ready(function(){      
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="addmore[][intitulePromotion]" placeholder="Entrer la promotion" class="form-control name_list" required /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X Supprimer</button></td></tr>');  
      });
