<aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo site_url('Index');?>"> <img alt="image" src="<?php echo base_url('assets/img/bangu.png');?>" class="header-logo" /> <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="<?php echo site_url("Index/login");?>" class="nav-link"><i data-feather="monitor"></i><span>Accueil</span></a>
            </li>
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="briefcase"></i><span>Frais</span></a>
