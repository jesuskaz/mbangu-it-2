        ...
        <div class="card">
          <div class="boxs mail_listing">
            <div class="inbox-center">
              <div class="inbox-header w-100 p-3" style="background: whitesmoke;">
                  ...
                  <div class="">
                    <div class="card">
                      <div class="card-header">
                        ...
                        <td><a type="button" class="btn btn-success" href="<?php echo site_url('Faculte/promotion') ?>">Ajouter l'option</a></td>
                      </div>
                    ...
                    <div class="">
                      <table class="" id="dynamic_field">
                        <tr>
                          ...
                          <td><button type="button" name="add" id="add" class="btn btn-success mb-2 ml-2">Ajouter l'option</button></td>
                        </tr>
                      </table>
                    </div>
                    <div class="mt-3">
