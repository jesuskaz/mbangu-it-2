      ...
      <div class="card">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4>Votre Promotion</h4><td><a type="button" class="btn btn-success" href="<?php echo site_url('Faculte/promotion')?>">Ajouter l'option</a></td>
                  </div>
                  <div class="card-body">
                    <!-- primary -->
                    <?php
                      if(isset($promotions))
                      {
                        foreach($promotions as $promotion)
                        {
                          ...
                          <input type="checkbox" name="promotionChose[]" value="<?php echo $promotion["intitulePromotion"]; ?>"/> 
                          <div class="state p-primary">
                            <label><?php echo  $promotion["intitulePromotion"]?></label>
                          </div>
                        </div>
                        <?php
                        }
                                ...
                                <tr>  
                                  <td>
                                    ...
                                    <select type="text" id="email_address" name= "faculte" class="form-control" placeholder="Banque" required focus>
                                        <option selected>Choisissez une Faculte ...</option>
                                 ...
                                 <td><input type="text" name="addmore[][intituleOptions]" placeholder="Entrer l'option" class="form-control name_list" required="" /></td>  
                                <td><button type="button" name="add" id="add" class="btn btn-success">Ajouter l'option</button></td>  
                            </tr>  
                        </table>  
                          </div>
                        <div class="col-lg-12">
