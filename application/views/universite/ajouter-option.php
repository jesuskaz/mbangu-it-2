...
<div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-bordered" id="dynamic_field">  
                                <tr>  
                                  <td>
                                    <div class="form-line">
                                    <select type="text" id="email_address" name= "option" class="form-control" placeholder="Banque" required focus>
                                        <option selected>Choisissez une option ...</option>
                                        <?php foreach($options as $option)
                                        {
                                        ?>
                                            <option value="<?php echo $option["idOption"]; ?>"><?php echo $option["intituleOption"]; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                 ...
                                 <td><input type="text" name="addmore[][intitulePromotion]" placeholder="Entrer promotion" class="form-control name_list" required="" /></td>  
                                <td><button type="button" name="add" id="add" class="btn btn-success">Ajouter un champs</button></td>  
                            </tr>  
                        </table>  
                          </div>
                        <div class="col-lg-12">
                            <div class="m-l-25 m-b-20">
                                <button type="submit" name="submit" id="submit" class="btn btn-info" value="Submit">Créer promotion</button> 
  ...
  <script type="text/javascript">
    ...
    {      
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="addmore[][intitulePromotion]" placeholder="Entrer promotion" class="form-control name_list" required /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X Supprimer</button></td></tr>');  
      });
