...
<body>
    ...
    <script>
        $(function() {
            ...
            function annonce() {
                $.getJSON("<?= site_url('ajax/annonce') ?>", "type=banque", function(f) {
                    var str = '';
                    var url = "<?= base_url('/') ?>";
                        ...
                        <div class="col-md-4">
                            <div class="card" style="width: 100%">
                                ...
                                <div class="card-footer d-flex justify-content-between">
                                    ...
                                    <a href='${url}banquee/annonce-e/${a.idannonce}' class='btn btn-link' ><i class='fa fa-edit' ></i></a>
