                      ...
                      <table class="table table-striped table-hover" style="width:100%;">
                        ...
                        <tbody>
                          ...
                          foreach ($etudiants as $etudiant) {
                            $i = $i + 1;
                            $sms = (int) $etudiant->nb_sms > 0 ? '<i style="cursor:pointer" title="SMS déjà envoyé à l\'étudiant " class="fa fa-check-circle text-success"></i>' : '';
                          ?>
                            <tr>
                              <td><?php echo $i; ?></td>
                              ...
                              <td class='d-inline-flex'>
                                ...
                                <button value='<?= $etudiant->idetudiant ?>' class='btn btn-warning btn-sm ml-2 mr-2 sms'><i class="fa fa-envelope"></i> <i>SMS</i></button>
                                <?= $sms ?>
                              </td>
                            </tr>
                          <?php } ?>
